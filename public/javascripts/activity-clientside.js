function listActivities(){
    ...
    $.get("/list", function (data) {
        ...
        for (var i = 0; i < data.list.length; i++) {
            ...
            $("#results").append(`<div class='card' style='width: 18rem;'><div class='card-body'><p class='card-text'> ${activity.name}</p><p class='card-text'>${activity.amount}</p><p class='card-text'>${activity.type}</p><button onclick='getActivityById()'><i class=\"fas fa-edit\"></i></button></div></div>`);
